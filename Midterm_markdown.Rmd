...
inTrain <- createDataPartition(
              y = paste(studentData.training$mean_distance, 
                        studentData.training$nbrBedRoom, 
                        studentData.training$withinCity, 
                        studentData.training$nbrRoomsNobath, 
                        studentData.training$mainfloorSF,
                        studentData.training$TotalFinishedSF),
              times = 1,
              p = .70, 
              list = FALSE)
