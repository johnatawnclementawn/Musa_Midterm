...
modelsummary(reg1, output = "kableExtra", stars = TRUE, gof_omit = 'IC|Log|AIC|BIC')
```
...
test %>%
  ...
  labs(title = "MAPE as a function of average home prices by Neighborhood") +
  plotTheme()

```


### Over/Under prediction through Racial lense
```{r}
acsZipsCol.2019.sf <- acsZipsCol.2019.sf %>%
