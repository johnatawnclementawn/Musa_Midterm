...
# ZIPCODE DATA IS CURRENTLY NOT WORKING. THERE'S A GIANT HOLE IN THE MIDDLE OF COLORADO WITH NO POINTS. 
...
flood_pts <- st_sample(flood_boundaries, size = 2500, type = 'regular')
...
bind_rows(
  ...
  ggplot(aes(mean_distance,price)) +
    geom_point(size = .5) +
    geom_smooth(method = "lm", se = F, colour = "#FA7800") +
    labs(title = "Nearest Neighbor Average and Price") +
  facet_wrap(~nn) +
    plotTheme()
```
