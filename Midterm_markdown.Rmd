...
studentData <- studentData %>%
  mutate(recreation_nn1 = nn_function(st_c(studentData), st_c(Recreation), 1),
         recreation_nn2 = nn_function(st_c(studentData), st_c(Recreation), 2),
         recreation_nn3 = nn_function(st_c(studentData), st_c(Recreation), 3),
         recreation_nn4 = nn_function(st_c(studentData), st_c(Recreation), 4),
         recreation_nn5 = nn_function(st_c(studentData), st_c(Recreation), 5))

studentData <- studentData %>%
  mutate(pd_nn1 = nn_function(st_c(studentData), st_c(PoliceDepartments), 1),
         pd_nn2 = nn_function(st_c(studentData), st_c(PoliceDepartments), 2),
         pd_nn3 = nn_function(st_c(studentData), st_c(PoliceDepartments), 3),
         pd_nn4 = nn_function(st_c(studentData), st_c(PoliceDepartments), 4),
         pd_nn5 = nn_function(st_c(studentData), st_c(PoliceDepartments), 5))

studentData <- studentData %>%
  mutate(fd_emt_nn1 = nn_function(st_c(studentData), st_c(FireandEMT), 1),
         fd_emt_nn2 = nn_function(st_c(studentData), st_c(FireandEMT), 2),
         fd_emt_nn3 = nn_function(st_c(studentData), st_c(FireandEMT), 3),
         fd_emt_nn4 = nn_function(st_c(studentData), st_c(FireandEMT), 4),
         fd_emt_nn5 = nn_function(st_c(studentData), st_c(FireandEMT), 5))

studentData <- studentData %>%
  mutate(hospitals_nn1 = nn_function(st_c(studentData), st_c(Hospitals), 1),
         hospitals_nn2 = nn_function(st_c(studentData), st_c(Hospitals), 2),
         hospitals_nn3 = nn_function(st_c(studentData), st_c(Hospitals), 3),
         hospitals_nn4 = nn_function(st_c(studentData), st_c(Hospitals), 4),
         hospitals_nn5 = nn_function(st_c(studentData), st_c(Hospitals), 5))

studentData <- studentData %>%
  mutate(malls_nn1 = nn_function(st_c(studentData), st_c(ShoppingMalls), 1),
         malls_nn2 = nn_function(st_c(studentData), st_c(ShoppingMalls), 2),
         malls_nn3 = nn_function(st_c(studentData), st_c(ShoppingMalls), 3),
         malls_nn4 = nn_function(st_c(studentData), st_c(ShoppingMalls), 4),
         malls_nn5 = nn_function(st_c(studentData), st_c(ShoppingMalls), 5))

studentData <- studentData %>%
  mutate(dispensaries_nn1 = nn_function(st_c(studentData), st_c(Dispensaries), 1),
         dispensaries_nn2 = nn_function(st_c(studentData), st_c(Dispensaries), 2),
         dispensaries_nn3 = nn_function(st_c(studentData), st_c(Dispensaries), 3),
         dispensaries_nn4 = nn_function(st_c(studentData), st_c(Dispensaries), 4),
         dispensaries_nn5 = nn_function(st_c(studentData), st_c(Dispensaries), 5))
```
