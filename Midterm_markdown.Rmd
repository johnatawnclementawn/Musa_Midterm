...
Includes point data where nearest neighbor was calculated
...
We also brought in data about locations of libraries.
...
Below we've included some plots that we thought would be interesting in this analysis. We've included numeric and categorical values to evaluate which variables are correlated with price. 
```{r}
...
## Code hoarding because we have a problem
