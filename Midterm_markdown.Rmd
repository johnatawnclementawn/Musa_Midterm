...
#### Census 2019
The first fixed effect variables that we looked at was census tract. With the census tract data we pulled variables on Race and Median age. Race was important as a fixed effect to predict housing prices. 
...
```{r Race_dontrun, message=FALSE, warning=FALSE, include=FALSE}
